...
function updatePreview() {
  ...
  previewEl.textContent = 'Destino sugerido: ' + concept.category + ' > ' + concept.concept + ', fila ' + concept.row + ', ' + month.label + '.';
}
...
form.addEventListener('submit', async (event) => {
  ...
  try {
    ...
    statusEl.textContent = 'Gasto cargado directo en ' + result.destino + '. Nuevo total: $' + formatAmount(result.valorNuevo) + (result.comprobante ? ' con comprobante guardado' : '') + '.';
...
form.addEventListener('submit', async (event) => {
  ...
  try {
    ...
    statusEl.className = 'status ok';
    statusEl.textContent = 'Gasto cargado directo en ' + result.destino + '. Nuevo total: $' + formatAmount(result.valorNuevo) + '.';
